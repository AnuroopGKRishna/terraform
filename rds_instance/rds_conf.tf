...
resource "aws_db_instance" "game_rds_instance" {
  identifier        = "${var.game_name}-${var.rds_instance_identifier}"
  ...
  vpc_security_group_ids = ["${aws_security_group.game_db_access.id}"]
...
# Security groups
resource "aws_security_group" "game_db_access" {
  name        = "${var.game_name}-${var.rds_instance_identifier}-access"
...
resource "aws_security_group_rule" "allow_db_access" {
  ...
  security_group_id = "${aws_security_group.game_db_access.id}"
}
